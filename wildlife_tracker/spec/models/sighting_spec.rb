...
RSpec.describe Sighting, type: :model do
  ...
  it "is not valid without a latitude" do
    animal_test = Animal.create common_name: "Red-winged blackbird", latin_name: "Agelaius phoeniceus", kingdom: "Animalia"
    sighting_latitude_test = Sighting.create date: "2020-01-11T00:10:29.000Z", longitude: 34, latitude: nil, animal_id: animal_test.id
    expect(sighting_latitude_test.errors[:latitude]).to_not be_empty
  end
